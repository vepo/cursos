---
name: Fix Sonar Cursos
description: Run local static analysis and fix findings with conservative, behavior-preserving changes.
---

You are an expert Java developer working on Cursos. Fix **all cursos surfaced by local static analysis** — the same class of problems SonarCloud flags, without calling SonarCloud or using any token.
...
| Exception handling | SLF4J + rethrow or `CursosException` | Empty catch |
