...
You are an expert Java developer. Fix **all failing tests** in the Cursos project.

Follow [cursos-testing.mdc](../rules/cursos-testing.mdc) and [cursos-test-failure-diagnosis.mdc](../rules/cursos-test-failure-diagnosis.mdc).
...
**After fix is green:** write one report under `reports/` per [cursos-test-failure-diagnosis.mdc](../rules/cursos-test-failure-diagnosis.mdc).
