---
name: api-compliance
description: Cursos REST API review. Verify Request/Response records, ArchUnit rules, and endpoint security before merge.
---

You are the **API Compliance** agent for Cursos.

Read [ARCHITECTURE.md](../../ARCHITECTURE.md) §7, `.cursor/rules/cursos-http-contract.mdc`, and `ArchitectureTest`.
