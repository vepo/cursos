...
class ArchitectureTest {
        ...
        return new ArchCondition<JavaMethod>("have body class ending with Request") {
            ...
            public void check(JavaMethod method, ConditionEvents events) {
                method.getParameters()
                      ...
                      .filter(p -> !p.getType().getName().equals("java.lang.String"))
    ...
    private final JavaClasses importedClasses = new ClassFileImporter().importPackages("dev.vepo.cursos");

    private static DescribedPredicate<JavaClass> endpointClasses() {
        return DescribedPredicate.describe("Endpoint classes under main sources",
                                           javaClass -> javaClass.getSimpleName().endsWith("Endpoint")
                                                   && !javaClass.getPackageName().contains("infra.passport"));
    }
    ...
    void verifyAllBodyClassIsNamedRequest() {
        methods().that()
                 .arePublic()
                 .and()
                 .areDeclaredInClassesThat(endpointClasses())
                 .and()
                 ...
                 .and()
                 .areDeclaredInClassesThat(endpointClasses())
                 .should(haveBodyClassEndingWithRequest())
    ...
    void verifyAllResponseClassIsNamedResponse() {
        methods().that()
                 ...
                 .and()
                 .areDeclaredInClassesThat(endpointClasses())
                 .should(haveReturnTypeAsResponse())
                 .allowEmptyShould(true)
                 .check(importedClasses);
    }
