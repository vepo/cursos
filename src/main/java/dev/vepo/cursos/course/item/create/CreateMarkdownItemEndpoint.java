...
import dev.vepo.cursos.course.CreateMarkdownItemRequest;
...
@Path("/courses/{courseId}/items/markdown")
@ApplicationScoped
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
@DenyAll
@Tag(name = "CourseItems")
public class CreateMarkdownItemEndpoint {
    private final CourseService courseService;
    private final CurrentPassportUser currentPassportUser;

    @Inject
    public CreateMarkdownItemEndpoint(CourseService courseService, CurrentPassportUser currentPassportUser) {
