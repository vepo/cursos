...
import dev.vepo.cursos.course.UpdateMarkdownItemRequest;
...
public class UpdateMarkdownItemEndpoint {
    private final CourseService courseService;
    private final CurrentPassportUser currentPassportUser;

    @Inject
    public UpdateMarkdownItemEndpoint(CourseService courseService, CurrentPassportUser currentPassportUser) {
